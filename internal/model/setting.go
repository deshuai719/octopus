...
const (
	...
	SettingKeyDirectCaptureProxyURL            SettingKey = "direct_capture_proxy_url"             // 直接捕获上游校验专用代理(http/https/socks5), 空=直连
...
func DefaultSettings() []Setting {
	return []Setting{
		...
		{Key: SettingKeyDirectCaptureProxyURL, Value: ""},             // 空=直连; 可填 resin 网关 http://Default:token@resin:2260
...
func (s *Setting) Validate() error {
	...
	case SettingKeyProxyURL, SettingKeyDirectCaptureProxyURL:
		if s.Value == "" {
			return nil
		}
